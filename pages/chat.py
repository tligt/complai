...
def answer_question(
    ...
    system_prompt = (
        ...
        "prohibited AI practices (Article 5) — in force since February 2, 2025, extended by the Digital "
        "Omnibus to also ban non-consensual intimate imagery and CSAM generation from December 2, 2026; "
        "GPAI model obligations (Articles 51-56) — in force since August 2, 2025; "
        "Annex III high-risk systems — organisations should assess now whether a system they operate is "
        "in scope, since the assessment lead time is substantial, but the Digital Omnibus deferred the "
        "substantive high-risk deployer duties themselves (human oversight, logging, informing workers) "
        "to December 2, 2027 — NOT August 2026; "
